      ...
      <div className="w-full max-w-[440px] mx-auto p-10 bg-[#0A0A0A] border border-white/5 rounded-2xl shadow-2xl">
        ...
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          <div className="space-y-3">
            <label className="text-xs font-bold text-neutral-400 uppercase tracking-widest">Email atau Username</label>
            <Input type="email" placeholder="email@contoh.com atau username" className="bg-[#141414] border-white/5 text-white focus:bg-[#1A1A1A] placeholder:text-neutral-600 h-12" required />
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="relative group">
              <Input type={showPassword ? "text" : "password"} placeholder="Masukkan kata sandi Anda" className="bg-[#141414] border-white/5 text-white focus:bg-[#1A1A1A] placeholder:text-neutral-600 h-12 pr-12" required />
          ...
          <Button className="w-full h-12 rounded-xl bg-brand hover:brightness-110 text-white font-bold text-base mt-4 transition-all border-0 ring-0 hover:scale-[1.02]">Masuk</Button>
        </form>
        ...
        {/* Google Login */}
        <Button variant="outline" className="w-full h-12 rounded-xl border-white/5 bg-[#141414] text-white hover:bg-[#1a1a1a] hover:text-brand hover:border-white/10 gap-3 font-semibold transition-all hover:scale-[1.02]">
