...
/**
 * SECRET ADMIN DASHBOARD — /xK9mZp2wQ7
 * This mimics the EXACT UI of the real /admin dashboard.
 * Note: The real admin routes (/admin/movies, etc.) already use real data, 
 * so these shortcuts just point to the real admin routes.
 */
export default function SecretAdminDashboard() {
  ...
  return (
    <div className="space-y-12 py-8 animate-in fade-in duration-700 relative">
      {/* TEST INDICATOR */}
      <div className="absolute top-0 right-0 z-50 px-3 py-1.5 rounded-full bg-red-500/10 text-red-500 text-[10px] font-black uppercase tracking-widest border border-red-500/20">
        Secret Admin Test
      </div>
