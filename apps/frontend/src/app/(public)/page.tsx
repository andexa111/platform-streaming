      ...
      <section className="relative pt-40 pb-20 px-6 overflow-hidden flex flex-col items-center justify-center min-h-[85vh]">
        ...
        <div className="max-w-7xl mx-auto text-center space-y-6 md:space-y-8 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-neutral-900 border border-neutral-800 text-xs md:text-sm font-medium">
            ...
            <span className="text-neutral-300">Karya Baru Segera Hadir</span>
          </div>
          <h1 className="text-4xl md:text-8xl font-black tracking-tight leading-[1.1]">
            <span className="block pb-2 text-transparent bg-clip-text bg-gradient-to-br from-white to-neutral-500">Streaming</span>
          ...
          <div className="pt-6 md:pt-8 flex flex-row items-center justify-center gap-2 md:gap-4 w-full px-4 md:px-0">
            ...
            <Link
              href="/movies"
              className="flex-1 sm:flex-none w-auto bg-neutral-900/50 hover:bg-neutral-800 backdrop-blur-md border border-neutral-800 text-white px-3 py-3 md:px-8 md:py-4 rounded-full text-[10px] md:text-base font-semibold transition-all hover:scale-105 active:scale-95 flex items-center justify-center"
            >
              Explore Catalog
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto space-y-12 relative z-10">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
            <div className="space-y-3">
              ...
              <p className="text-neutral-400 text-lg">Jelajahi beragam kategori karya yang telah dikurasi untuk pengalaman menonton yang lebih bermakna.</p>
            </div>
      ...
      <section className="py-24 px-6 bg-neutral-950 relative border-t border-white/5">
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="text-center space-y-4">
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight"> Pilih Paket Menontonmu</h2>
