        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 animate-in fade-in duration-300">
          ...
          <div className="relative w-full max-w-md bg-card border border-border rounded-[2.5rem] p-8 md:p-10 shadow-2xl animate-in zoom-in-95 duration-300 flex flex-col items-center text-center space-y-8">
            ...
            <div className="space-y-3">
              <h2 className="text-2xl md:text-3xl font-black tracking-tight text-foreground">Join LALAKON</h2>
              <p className="text-muted-foreground text-sm md:text-base leading-relaxed">Silakan masuk ke akun Anda atau daftar sekarang untuk menikmati ribuan film berkualitas 4K di platform kami.</p>
            </div>
      ...
      <div className="relative">
                  ...
                  <div className="absolute inset-0 bg-neutral-900 flex items-center justify-center overflow-hidden">
                    ...
                    <div className="relative flex flex-col items-center gap-6 z-10">
                      <div className="w-24 h-24 rounded-full bg-brand flex items-center justify-center shadow-[0_0_50px_rgba(2,77,148,0.5)] animate-pulse">
                        <Icon name="play" className="w-10 h-10 fill-current text-white" />
                      </div>
                      <div className="text-center space-y-2">
                        <p className="text-xl font-bold tracking-tight text-white">Menampilkan Video: {movie.title}</p>
        ...
        <div
          className={cn(
            ...
            isPlaying ? "relative pt-5 pb-4" : "absolute bottom-0 left-0 right-0 z-20 h-full justify-end pb-20 md:pb-32 bg-gradient-to-t from-background via-transparent to-transparent",
          )}
        >
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-2 md:gap-4">
              ...
              <span className="text-muted-foreground text-xs md:text-sm font-medium">2024</span>
              <span className="text-muted-foreground text-xs md:text-sm font-medium">2h 15m</span>
      ...
      <section className={cn("relative z-30 px-6 pb-24 max-w-7xl mx-auto space-y-16 transition-all duration-700", isPlaying ? "pt-10" : "-mt-10 md:-mt-20")}>
        ...
        <div className="space-y-10">
          <div className="flex items-end justify-between">
            <div className="space-y-3">
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight">Film Serupa</h2>
              <p className="text-muted-foreground">Film pilihan yang mungkin Anda sukai berdasarkan minat Anda.</p>
            </div>
          </div>
