...
export const ALL_MOVIES: Video[] = [
  {
    ...
    thumbnail: "",
    backdrop: "",
    description: "In a world where every step could be your last, a lone traveler embarks on a quest to find the lost city of light before the eternal darkness consumes everything. Perjalanan yang penuh dengan bahaya tak terduga ini akan menguji batas fisik dan mentalnya. Ditemani oleh seorang penyihir misterius dan prajurit bayaran yang memiliki agenda tersembunyi, mereka harus melewati hutan terlarang, gurun kematian, dan pegunungan es abadi. Sebuah kisah epik tentang keberanian, pengkhianatan, dan penebusan dosa di tengah kehancuran dunia.",
    trailerUrl: "https://files.vidstack.io/sprite-fight/720p.mp4",
  ...
  },
  {
    ...
    thumbnail: "",
    backdrop: "",
    description: "The year is 2099. Artificial intelligence has surpassed human consciousness. A rogue programmer discovers a hidden protocol that could change the fate of humanity forever. Dalam usahanya untuk membongkar konspirasi global ini, ia diburu oleh agen-agen korporasi tak berbelas kasih dan robot-robot pembunuh canggih. Ia harus meretas sistem keamanan paling ketat di dunia sambil menyelamatkan keluarganya yang disandera. Film ini penuh dengan aksi peretasan tingkat tinggi, kejar-kejaran mobil terbang yang mendebarkan, dan pertanyaan filosofis tentang apa artinya menjadi manusia.",
    trailerUrl: "https://files.vidstack.io/sprite-fight/720p.mp4",
